...
import keyboards
from config import PLITKANADOM_BOT
...
# OPENA_KEY = 'YOUR_OPEN_A_KEY'
# openai.api_key = OPENA_KEY
...
button_plitka = KeyboardButton(text="Плитка, мозаика")
...
async def send_start(message: Message):
    ...
    await message.answer("Добрый день! Я чат-бот магазина керамической плитки, сантехники и напольных покрытий www.plitkanadom.ru"
                         "\nЯ могу помочь вам их подобрать:", reply_markup=keyboards)
